...
$port = 6543; // Ensure this is the correct port for your Supabase PostgreSQL instance
...
<body>
    <div class="container">
        ...
        <table>
            ...
            <?php if (!empty($data) && !isset($data[0]['message'])): ?>
            ...
            <?php else: ?>
                <tr>
                    <td colspan="8"><?php echo $data[0]['message']; ?></td>
                </tr>
            <?php endif; ?>
        </table>
        <br>
